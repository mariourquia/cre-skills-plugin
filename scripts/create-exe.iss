...
WelcomeLabel2=This will install the CRE Skills Plugin v{#AppVersion} on your computer.%n%n127 institutional-grade CRE skills covering deal sourcing, underwriting, capital markets, leasing, asset management, investor relations, development, and more.%n%nClaude Code: 127 skills, 54 agents, hooks, commands.%nClaude Desktop: 21 MCP tools (route, workspace, feedback, customize).%n%nApache License 2.0
