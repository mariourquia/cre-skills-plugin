...
Available chains:
1. **Acquisition Pipeline**: sourcing -> screening -> underwriting -> IC memo -> LOI -> PSA -> DD -> close
2. **Capital Stack Assembly**: underwriting -> loan sizing -> mezz/pref -> JV waterfall -> optimizer -> refi
