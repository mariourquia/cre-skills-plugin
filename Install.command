...
printf "${BLUE}  Plugin Installer v5.1.0${RESET}\n"
...
PLUGIN_VERSION="$(python3 -c "import json; print(json.load(open('$SCRIPT_DIR/.claude-plugin/plugin.json'))['version'])" 2>/dev/null || echo "5.1.0")"
