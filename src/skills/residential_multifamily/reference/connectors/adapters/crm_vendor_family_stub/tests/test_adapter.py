"""CRM vendor family stub: manifest and payload conformance tests."""
...
def test_crm_adapter_conforms(adapter_manifest_schema):
    run_adapter_manifest_checks(
        adapter_dir=ADAPTER_DIR,
        schema=adapter_manifest_schema,
        expected_connector_domain="crm",
        expected_vendor_family="generic_crm_stub",
    )
