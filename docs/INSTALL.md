...
1. Download [`cre-skills-plugin-v4.5.0.dmg`](https://github.com/mariourquia/cre-skills-plugin/releases/latest) from the latest release.
...
1. Download [`cre-skills-plugin-v4.5.0-setup.exe`](https://github.com/mariourquia/cre-skills-plugin/releases/latest) from the latest release.
